...
# A9-P2-10: доменный справочник переехал в utils/categories.py; ре-экспорт тех же
# объектов (identity) для хендлеров и клавиатур этого модуля.
from uk_management_bot.utils.categories import (  # noqa: F401
    CATEGORY_KEYS,
