...
class EmployeeManagementStates(StatesGroup):
    ...
    # `editing_full_name` удалено вместе со своим хендлером: исправление ФИО
    # переехало в общий флоу (states/user_rename.py), где оно одно на карточку
    # жителя и карточку сотрудника.
