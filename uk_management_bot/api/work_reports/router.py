...
Статичные пути объявлены до `/{report_id}` (house style, см.
`api/materials/router.py`) — здесь это не реальная routing-опасность (разные
HTTP-методы/шейпы), но конвенция сохранена.
"""
import logging
