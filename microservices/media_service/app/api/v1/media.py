...
async def upload_media(
    ...
    """
    # Get observability service for tracking
    observability = await get_observability()

    # Track upload operation
    async with observability.track_operation(
        "media_upload",
        ...
        try:
            ...
            await observability.record_upload_metrics(
                file_size=len(file_data),
                duration_ms=0,  # Will be calculated by track_operation
                success=True
            )
