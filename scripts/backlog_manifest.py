...
ASSIGNMENT: dict[str, dict] = {
    ...
    "BUG-153": A(pkg="A2", status="actionable", method="verified-2026-08-14",
                 note="7 дефектов волны 4 (#438); п.5 ЗАКРЫТ #446 — открыты пп.1-4,6 (язык адресата, RU-хардкод, id-микс, NULL-strftime)"),
    ...
    "BUG-164": A(pkg="A2", status="actionable", method="decision-2026-08-19",
                 note="решение 2026-08-19: убрать «Заявитель» из клавиатуры выдачи (keyboards/admin.py:83 + тест)"),
    ...
    "BUG-167": A(pkg="A2", status="actionable", method="decision-2026-08-19",
                 note="решение 2026-08-19: все девять канон-специализаций равнозначны — метрика по канон-набору + тест на реальных сменах"),
    "BUG-168": A(pkg="A2", status="actionable", method="decision-2026-08-19",
                 note="решение 2026-08-19: привести предикат к канону BUG-166 (джокер+нормализация, расширение видимости универсалов одобрено); тест паритета sync/async"),
    ...
    "BUG-171": A(pkg="A2", status="actionable", method="decision-2026-08-19",
                 note="решение 2026-08-19: добавить general в канон (COMMENT_TYPES + локали ru/uz) — кнопка становится рабочей"),
