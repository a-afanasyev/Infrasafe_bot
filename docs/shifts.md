...
> **📌 Актуальная тех-версия:** [docs/tech/SHIFTS_AND_ASSIGNMENT.md](./tech/SHIFTS_AND_ASSIGNMENT.md)
> Данный файл — продуктовый/концептуальный обзор. Источник истины по реализации
> (жизненный цикл смены, передача, шаблоны, движок назначения) — тех-документ выше,
> где все утверждения проверяемы по `file:line`. При расхождениях приоритет у тех-версии.
...
> **Актуальный статус реализации** (жизненный цикл смены, передача смен REG-02/03,
> шаблоны, движок назначения после ARC-03/ARC-04) описан в тех-версии:
> [docs/tech/SHIFTS_AND_ASSIGNMENT.md](./tech/SHIFTS_AND_ASSIGNMENT.md). Разделы ниже —
> концептуальный обзор и продуктовый контекст.
