...
Из них actionable по приоритету: P1=1, P2=8, P3=14.
...
| `BUG-171` | P2 | decision | verified-2026-08-18 | A2 | — | — | — | ЖИВОЙ: кнопка «Общий комментарий» падает всегда — тип general вне COMMENT_TYPES; добавить в канон или убрать кнопку — продуктовое |
| `BUG-173` | P3 | actionable | verified-2026-08-18 | A2 | — | — | — | UpdateShiftBody не валидирует specialization_focus (в отличие от Create) — разметка из PATCH доезжает до HTML-сообщений менеджеру |
| `BUG-174` | P2 | actionable | verified-2026-08-18 | A2 | — | — | — | ЖИВОЙ: уведомления о комментариях не уходят никому — send_notification у сервиса нет; лечится B3-раскроем, notify_user не годится (нет loop в run_db) |
| `BUG-175` | P1 | actionable | verified-2026-08-18 | A2 | — | — | — | P1 ЖИВОЙ: адресный кластер и модерация квартир — 59 хендлеров, 0 проверок роли; житель одобряет себе квартиру = эскалация доступа к заявкам |
