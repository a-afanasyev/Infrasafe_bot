...
Из них actionable по приоритету: P2=11, P3=14.
...
| `ARCH-135` | P3 | actionable | verified-2026-08-02 | — | — | — | — | группа (а)/API закрыта 2026-08-02 (бизнес-бакеты статистики + SWEPT-гейт); остаток — 22 сайта в движках, где бакет меняет РЕШЕНИЯ алгоритма |
| `ARCH-137` | P2 | actionable | verified-2026-08-05 | — | — | — | — | фазы A/B-бэк/C-показ раскатаны; B-фронт закрыт в коде — остаток только раскатка фронта |
| `ARCH-138` | P3 | actionable | verified-2026-08-05 | — | — | — | — | 4 access-сайта datetime-local в зоне браузера; канон fromDisplayTz уже есть (B-фронт) |
