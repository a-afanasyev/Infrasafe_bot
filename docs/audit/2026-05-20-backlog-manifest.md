...
Из них actionable по приоритету: P2=6, P3=14.
...
|---|---|---|---|---|---|---|---|---|
| `AUD3-07` | P2 | decision | verified-2026-08-19 | A2 | — | — | — | .query( в async def = 0 (волны закрыты), но цель не достигнута: sync-сессия в loop ещё в 26 файлах / ~170 хендлерах (метрика гейта aud337) — программа A2-2 или деферрал класса, решение владельца |
...
| `BUG-171` | P2 | decision | verified-2026-08-19 | A2 | — | — | — | ЖИВОЙ: кнопка «Общий комментарий» падает всегда — тип general вне COMMENT_TYPES; добавить в канон или убрать кнопку — продуктовое |
...
| `BUG-148` | P2 | decision | verified-2026-08-19 | A3 | — | — | — | мёртвый auto-assign путь планировщика; оживление=продуктовое решение (2 мины) vs ретайр |
