...
- пунктов всего (с Priority): **432**
- закрыто маркером: **402**
- открыто маркером: **30**
...
Из них actionable по приоритету: P2=7, P3=12.
...
| `BUG-160` | P2 | decision | verified-2026-08-16 | A2 | — | — | — | исполнитель не узнаёт о назначении на смену: метода send_shift_assignment_notification нет в репо; нужен НОВЫЙ текст уведомления = продуктовое решение (реализовать по канону shifts.py vs снять вызов) |
