...
| `DEAD-134` | P2 | decision | verified-2026-07-28 | — | — | — | — | хендлеры отчётов/комментариев зарегистрированы, но входа из UI нет — 6 билдеров с 0 ссылок; подключить или удалить |
