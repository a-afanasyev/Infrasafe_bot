...
- пунктов всего (с Priority): **436**
- закрыто маркером: **405**
- открыто маркером: **31**
...
| `BUG-163` | P3 | actionable | verified-2026-08-16 | A2 | — | — | — | uz-житель получает русские шаги выбора квартиры: language не проброшен в 2 вызова onboarding.py |
