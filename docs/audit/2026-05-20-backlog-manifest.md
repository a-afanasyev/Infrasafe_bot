...
- пунктов всего (с Priority): **456**
- закрыто маркером: **420**
- открыто маркером: **36**
...
Из них actionable по приоритету: P2=8, P3=21.
...
| `BUG-182` | P3 | actionable | verified-2026-08-19 | A2 | — | — | — | житель уведомляется на каждое переназначение — нужен выбор владельца |
