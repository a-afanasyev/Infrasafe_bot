...
- пунктов всего (с Priority): **448**
- закрыто маркером: **415**
- открыто маркером: **33**
...
Из них actionable по приоритету: P2=9, P3=18.
...
|---|---|---|---|---|---|---|---|---|
| `AUD3-07` | P2 | actionable | decision-2026-08-19 | A2 | — | — | — | решение 2026-08-19: деферрал класса + ратчет на не-рост (per-file baseline, 26 файлов / ~170 хендлеров по метрике aud337); после ратчета пункт остаётся deferred-трекером |
...
| `BUG-157` | P2 | actionable | verified-2026-08-19 | A2 | — | — | — | _get_user_language блокирует loop; транзитивная проверка гейта + механика inspector_requests:389; инвентарь класса целиком — в AUD3-07 (2026-08-19) |
...
| `BUG-173` | P3 | actionable | verified-2026-08-19 | A2 | — | — | — | UpdateShiftBody не валидирует specialization_focus (в отличие от Create) — разметка из PATCH доезжает до HTML-сообщений менеджеру |
| `BUG-174` | P2 | actionable | verified-2026-08-19 | A2 | — | — | — | ЖИВОЙ: уведомления о комментариях не уходят никому — send_notification у сервиса нет; лечится B3-раскроем, notify_user не годится (нет loop в run_db) |
