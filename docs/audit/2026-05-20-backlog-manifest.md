...
- пунктов всего (с Priority): **441**
- закрыто маркером: **407**
- открыто маркером: **34**
...
Из них actionable по приоритету: P2=8, P3=13.
...
| `BUG-154` | P3 | decision | verified-2026-08-14 | A2 | — | — | — | request_assignment мёртв целиком (~370 строк) + 3 в panels; решать с BUG-150 |
...
| `BUG-169` | P2 | actionable | verified-2026-08-17 | A2 | — | — | — | ЖИВОЙ: словарь перевода специализаций в боте на legacy-наборе — менеджер видит «electrician» вместо «Электрика» |
