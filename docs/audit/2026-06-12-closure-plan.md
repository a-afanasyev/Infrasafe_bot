...
| Ручной прод-SQL | BUG-BOT-017 (junk-шаблоны), MGR-09 (дубль здания, merge) | одобрено 2026-06-12, к выполнению (с дампом) |
...
| BUG-BOT-017 | **Одобрено** — ручная прод-чистка junk-шаблонов (с дампом) |
| MGR-09 | **Одобрено** — merge: перевесить ссылки на каноничное здание, дубль удалить (с дампом) |
