...
**⚠️ Marker-drift (расхождение бэклог↔код):** ряд закрытых в коде пунктов волн 3–4 НЕ зачёркнут в `2026-05-20-backlog.md` (`ARCH-01/02/05`, `ARCH-07`, `NICE-078`, `DB-060`, `FE-12` и др.) — заголовки `####` без `~~`/✅, хотя merge-PR #117-131 это сделали. При следующей вычитке бэклога — прогнать marker-hygiene-пасс по этому списку.
