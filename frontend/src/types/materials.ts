...
// Каталог категорий = сами строки (в БД category хранится свободным текстом,
// таблицы-справочника нет). Форма ограничивает выбор этим списком; legacy-значение
// вне списка форма подставляет отдельной опцией, чтобы не затереть при правке.
export const MATERIAL_CATEGORIES: readonly string[] = [
  'Озеленение и садовый инвентарь',
  'Материалы для эксплуатации зданий',
  'Лифтовое оборудование',
  'Системы безопасности и слаботочные системы',
  'Пожарная безопасность',
  'Запасные части для техники',
  'Мебель, техника и основные средства',
] as const
