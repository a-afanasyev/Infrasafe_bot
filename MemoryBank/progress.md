...
#### Следующие шаги:
1. **Добавить обработчики для кнопки "Создать заявку"**
2. **Создать клавиатуры для категорий и срочности**
3. **Реализовать обработку медиафайлов**
4. **Добавить функциональность "Мои заявки"**
