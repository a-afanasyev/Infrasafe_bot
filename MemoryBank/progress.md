...
**Статус**: ✅ CREATIVE ЗАВЕРШЕНА (04.08.2025)
...
- **Модель User**: Прямые поля (home_address, apartment_address, yard_address, address_type)
- **Миграция**: Простая миграция с ALTER TABLE
- **AuthService**: Расширение существующего сервиса
- **Утилиты**: utils/address_helpers.py для валидации и форматирования
- **Константы**: Типы адресов и ограничения в utils/constants.py

**Подзадачи**:
- [ ] **2.2.1.1: Добавление новых полей в модель User** - home_address, apartment_address, yard_address, address_type
- [ ] **2.2.1.2: Создание миграции базы данных** - SQL команды для новых колонок
- [ ] **2.2.1.3: Обновление сервиса AuthService** - методы для работы с адресами
- [ ] **2.2.1.4: Создание утилит для работы с адресами** - валидация и форматирование
- [ ] **2.2.1.5: Обновление констант** - типы адресов и ограничения
- [ ] **2.2.1.6: Тестирование изменений** - все сценарии работы с адресами
