#!/usr/bin/env python3
"""
Финальный скрипт для объединения дополнительных ключей локализации
"""
import json
import os
...
def merge_additional_keys():
    ...
    # Временные файлы с дополнительными ключами
    ru_temp_path = os.path.join(base_dir, "uk_management_bot/config/locales/ru_temp.json")
    uz_temp_path = os.path.join(base_dir, "uk_management_bot/config/locales/uz_temp.json")
    
    # Создаем временные файлы с дополнительными ключами
    ru_temp_data = {
        "buttons": {
